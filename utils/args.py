...
def get_args_parser():
    ...
    parser.add_argument('--save_every_epoch', type=bool, default=True,
                        help='Whether or not to save checkpoint every epoch')
    ...
    parser.add_argument("--nTestEpisode", default=600, type=int,
                        help="Number of episodes for meta-test.")
    ...
    parser.add_argument('--num_ways', type=int, default=None,
                        help='Set it if you want a fixed')
    ...
    parser.add_argument('--cdfsl_domains', nargs="+", default=['EuroSAT', 'ISIC', 'CropDisease', 'ChestX', 'cub', 'car', 'places', 'plantae'], help='CDFSL datasets')
    ...
    parser.add_argument('--ada_wd', default=0., type=float, help='weight decay of feature adaptation')
    ...
    parser.add_argument('--blend_beta', type=float, default=1.0)
    parser.add_argument('--blend_gamma', type=float, default=0.6)
    parser.add_argument('--specified_expert', type=int, nargs="+", default=None)
    ...
    parser.add_argument('--lr-scale', default=False, action="store_true", help="linear scale lr for 8 GPUs")
    ...
    parser.add_argument('--pgd_method', default="standard", type=str, choices=['standard', 'adsv'])
    parser.add_argument('--attack_norm', default="linf-pgd", type=str, choices=['linf-pgd', 'l2-pgd'])
    parser.add_argument('--epsilon', default=8, type=float)
    parser.add_argument('--alpha', default=2, type=float)
    parser.add_argument('--attack_iters', default=10, type=int)
    parser.add_argument('--delta_init', default="random", type=str, choices=['zero', 'random1', 'random2'])
    parser.add_argument("--beta", type=float, default=6.0)
    parser.add_argument('--eval_restarts', type=int, default=1)

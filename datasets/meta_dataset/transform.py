...
def get_transforms(data_config: DataConfig,
    ...
    if split == Split["TRAIN"]:
        if args.use_aa:
            return train_transform_autoaug(data_config)
        else:
            return train_transform(data_config, args)
    else:
        return test_transform(data_config, args)


def test_transform(data_config: DataConfig, args):
...
def train_transform(data_config: DataConfig, args):
...
def train_transform_autoaug(data_config: DataConfig):
